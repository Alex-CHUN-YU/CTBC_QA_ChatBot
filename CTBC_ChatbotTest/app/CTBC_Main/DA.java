...
public class DA {
     ...
     * CKIP斷詞.
     */
    private static ArrayList<POS.Tuple<String, String>> pos;
    
    /**
     * 查完辭典，更改詞性後的結果.
     */
    private static ArrayList<POS.Tuple<String, String>> revisePOS;

    /**
     * Entity.
     */
    private static ArrayList<POS.Tuple<String, String>> entity;
    ...
    public static void initial() throws IOException{
        ...
        entity = new ArrayList<POS.Tuple<String, String>>();
        revisePOS = new ArrayList<POS.Tuple<String, String>>();
        pos = new ArrayList<POS.Tuple<String, String>>();
     ...
     */
    private static void posDictionary(final String setName) throws IOException{
            try {
                readPOSDic(setName,
    ...
    private static BufferedReader getBufferedReader (final String fileName)
        ...
        return new BufferedReader(new InputStreamReader(new FileInputStream(path + fileName), "UTF-8"));
    }
